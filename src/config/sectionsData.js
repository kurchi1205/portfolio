			...
			tech: [
				{
					...
					items: [
						...
						{
							name: 'Web',
							items: ['HTML', 'CSS', 'Express', 'Node JS'],
						},
						{
							name: 'Data Science',
							items: ['Pytorch', 'Numpy', 'Matplotlib', 'Pandas', 'SQL', 'MLFlow'],
						},
						{
							name: 'Database',
				...
				},
				{
					...
					items: [
						{
							name: 'Visualization',
							items: ['Python Libraries', 'Weights and Biases'],
						},
						{
							name: 'Framework',
				...
				},
				{
					name: 'Domains',
					flatList: true,
					items: ['Data science', 'Cloud deployments', 'Mathematics'],
				},
			],
		},
	},
